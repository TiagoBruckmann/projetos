                ...
                <tbody>
                    @foreach
                        <tr>
                            ...
                            <td><img width="80px" src="{{ $registro->projeto }}"></td>
                            <td>
                                <a class="btn deep-black" onclick="editar()" href="{{ route('admin.projetos.editar', $registro->id) }}">Editar</a>
                                <a class="btn deep-black" onclick="deletar()" href="{{ route('admin.projetos.deletar', $registro->id' }}">Deletar</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
